...
Run exactly as in `offer` mode (read `modes/offer.md` for all blocks A-F).
...
1. **Extract form questions**: Use Playwright to navigate to the form and take a snapshot. If not available, use the generic questions below.
